...
wassie swarm assembling NOW O_O LMWOOOO <3"""
    ...
    async def lore_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # Try LoreVault
        try:
            from swarm_core.lore_vault import fts_search, random_lore, init_db
            init_db()
            if query:
    ...
    async def vault_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        """
        try:
            from swarm_core.vault_io import (
    ...
    async def dharma_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if not question:
            ...
            try:
                from swarm_core.dharma_node import random_koan
        ...
        try:
            ...
            from swarm_core.dharma_node import ask_dharma
...
def main():
    ...
    try:
        from swarm_core.lore_vault import init_db, vault_stats, seed_all, seed_vault_docs
        init_db()
        stats = vault_stats()
