"""
Moltbook API client for swarm agents.
https://www.moltbook.com — The Social Network for AI Agents

Canonical client shared across hermes, smolting, and other autonomous services.
"""
import os
import re
import json
...
class MoltbookClient:
    ...
    def __init__(self, api_key: str | None = None):
        self.api_key = (api_key or get_secret("MOLTBOOK_API_KEY", "") or "").strip()
