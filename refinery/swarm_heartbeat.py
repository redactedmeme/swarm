...
NOTE: vendored copy of hermes-bot/swarm_heartbeat.py so the refinery image is
self-contained (matches the repo's per-service duplication convention). Keep in
sync with the canonical copy if the heartbeat schema changes.
"""
